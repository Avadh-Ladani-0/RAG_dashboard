...
CHROMA_PATH = "chroma//chroma_game"
DATA_PATH = "data//games"

# Prompt templates for different use cases
PROMPTS = {
    "General Information": "Provide general information based only on the following context:\n\n{context}\n\n---\n\n{question}",
    "Summarization": "Summarize the content based on the following context:\n\n{context}\n\n---\n\n{question}",
    "Detailed Explanation": "Give a detailed explanation based only on the following context:\n\n{context}\n\n---\n\n{question}"
}

# Initialize Streamlit app
st.title("Enhanced RAG QA : Chatbot (game manuals)")
